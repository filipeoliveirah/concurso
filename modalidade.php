...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container">      
      <div class="col">        
        <h1>Cadastre uma Modalidade</h1>
        <div class="resp"></div>
        <form name="formulario" method="post">
          <div class="form-group">
            <input type="text" class="form-control" id="nomeModalidade" name="nomeModalidade" placeholder="Digite o nome da Modalidade">
          </div>
    ...
    <script>
        ...
        $('button[type=submit]').click(function(evento){
            ...
            if(array[0].value == ''){
                ...
                let request = $.ajax({
                    url: "forms/cadastrarmodalidade.php",
                    method: "POST",
                    data: { modalidade : nomeModalidade },
                    dataType: "json",
                    beforeSend: function(){
                    ...
                    if(valor.erro == 'sim'){
						...
						setTimeout(function () {
							window.location.href = "modalidade.php";
						}, 3000);			
					}
                });       
