...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container">      
      <div class="col">        
        <h1>Cadastre uma Banca</h1>
        <div class="resp"></div>
        <form name="formulario" method="post">
          <div class="form-group">
            <input type="text" class="form-control" id="nomeBanca" name="nomeBanca" placeholder="Digite o nome da banca">
          </div>
    ...
    <script>
        ...
        $('button[type=submit]').click(function(evento){
            ...
            if(array[0].value == ''){
                ...
                let request = $.ajax({
                    url: "forms/cadastrarbanca.php",
                    method: "POST",
                    data: { banca : nomeBanca },
                    dataType: "json",
                    beforeSend: function(){
