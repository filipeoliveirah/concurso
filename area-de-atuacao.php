...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container">      
      <div class="col">        
        <h1>Cadastre uma Área de Atuação</h1>
        <div class="resp"></div>
        <form name="formulario" method="post">
          <div class="form-group">
            <input type="text" class="form-control" id="nomeAreaDeAtuacao" name="nomeAreaDeAtuacao" placeholder="Digite o nome da Área de Atuação">
          </div>
    ...
    <script>
        ...
        $('button[type=submit]').click(function(evento){
            ...
            let nomeAreaDeAtuacao = $('#nomeAreaDeAtuacao').val();
            ...
            if(array[0].value == ''){
                ...
                let request = $.ajax({
                    url: "forms/cadastarareadeatuacao.php",
                    method: "POST",
                    data: { areaDeAtuacao : nomeAreaDeAtuacao },
                    dataType: "json",
                    beforeSend: function(){
                    ...
                    if(valor.erro == 'sim'){
						...
						setTimeout(function () {
							window.location.href = "area-de-atuacao.php";
						}, 3000);			
					}
                });       
