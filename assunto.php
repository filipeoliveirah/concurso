...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container">      
      <div class="col">        
        <h1>Cadastre um Assunto</h1>
        <div class="resp"></div>
        <form name="formulario" method="post">
          <div class="form-group">
            <input type="text" class="form-control" id="nomeAssunto" name="nomeAssunto" placeholder="Digite o nome da Assunto">
          </div>
          <div class="form-group">
            <select name="disciplina" class="form-control" id="exampleFormControlSelect1">
                <option value="">Assunto de qual disciplina?</option>
                <?php
    ...
    <script>
        ...
        $('button[type=submit]').click(function(evento){
            ...
            let nomeAssunto = $('#nomeAssunto').val();
            let idDaDisciplina = $('select[name=disciplina]').val();
            ...
            if(array[0].value == '' || array[1].value == ''){
                ...
                let request = $.ajax({
                    url: "forms/cadastrarassunto.php",
                    method: "POST",
                    data: { assunto : nomeAssunto, idDisciplina : idDaDisciplina },
                    dataType: "json",
                    beforeSend: function(){
                    ...
                    if(valor.erro == 'sim'){
						...
						setTimeout(function () {
							window.location.href = "Assunto.php";
						}, 3000);			
					}
                });       
